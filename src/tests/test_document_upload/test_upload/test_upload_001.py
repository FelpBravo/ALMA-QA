...
Seleccionar una carpeta y luego limpiar</br>
</br></br>""")

class test_upload_001(Selenium, unittest.TestCase):
    ...
    @allure.story(u'Comprobando que no desaparescan los elementos al limpiar.')
    def test_limpiar_004(self):
        ...
        with allure.step(u'PASO 5 : Comprobando visibilidad de los elementos'):
            ...
            self.assertTrue(carpetas and noIcd and docControlado and cargar and cargarDoc and etiquetas and limpiar, "Error, uno o mas elementos ya no son visibles")

    @allure.story(u'Limpiar el selector de carpetas.')
    def test_limpiar_005(self):
        ...
        with allure.step(u'PASO 6 : Presionando boton limpiar'):
            Selenium.esperar_elemento(self, "Limpiar")
            Selenium.get_elements(self, "Limpiar").click()
            Selenium.foto(self, "Despues de limpiar")
