...
@allure.testcase(u'[Flujo carga Doc] Funcionalidad de botones')
@allure.severity(allure.severity_level.NORMAL)
@allure.description(u"""validaciones: </br>
Cargar un documento controlado a travez del flujo, rellenando toda su metadata,
asignando a seis roles diferentes</br>
Validaciones en los campos requeridos</br>
Comprobar el estado del botón</br>
</br></br>""")

class test_flow_005(Selenium, unittest.TestCase):
    ...
    @allure.title(u'Validaciones')
    @allure.story(u'Se comprueba que al clikar en Siguiente con los campos vacios, estos campos esten validados mediante un mensaje')
