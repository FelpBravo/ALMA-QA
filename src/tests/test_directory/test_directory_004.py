...
@allure.description(u"""Crear un directorio y editarlo cambiando el nombre de este. Validar que al abrir de nuevo
el modal de edición, estas modificaciones persistan.</br>
</br></br>""")

class test_directory_004(Selenium, unittest.TestCase):
    ...
    def test_edit_002(self):
        ...
        with allure.step(u'PASO 4: Obteniendo nombres y validando directorio creado'):
            ...
            if any == 2:
                ...
                assert current == checkbox, f"ERROR, EL CHECKBOX NO ESTA EN '{checkbox}', COMO SE DEJÓ EDITADO" \
                                            f" ANTERIORMENTE."
